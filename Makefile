...
debug:
	@g++ -fcoroutines -MD -Wall -Wextra -std=c++20 -g -ggdb -DDEBUG -Wfatal-errors -Wall -Wextra -Wshadow -Wconversion -Wnon-virtual-dtor -Wold-style-cast -Wcast-align -Wunused -Wmisleading-indentation -Wduplicated-cond -Wduplicated-branches -Wsign-conversion -Wlogical-op -Wnull-dereference -Wuseless-cast -Wdouble-promotion -Wformat=2 -Woverloaded-virtual -Wno-null-dereference -pedantic -Wswitch-enum -iquote include -isystem submodules -isystem external_header -o ./bin/sstm-debug src/main.cpp src/stb_image.cpp src/glad.c -lglfw -lGL -lX11 -lpthread -lXrandr -lXi -ldl -lassimp -lboost_serialization

release: CXXFLAGS += -O3 -DNDEBUG -Wno-unused-but-set-variable -Wno-unused-parameter
release:
	@g++ -fcoroutines -MD -Wall -Wextra -std=c++20 -O3 -DNDEBUG -Wfatal-errors -Wall -Wextra -Wshadow -Wconversion -Wnon-virtual-dtor -Wold-style-cast -Wcast-align -Wunused -Wmisleading-indentation -Wduplicated-cond -Wduplicated-branches -Wsign-conversion -Wlogical-op -Wnull-dereference -Wuseless-cast -Wdouble-promotion -Wformat=2 -Woverloaded-virtual -Wno-null-dereference -pedantic -Wswitch-enum -O3 -iquote include -isystem submodules -isystem external_header -o ./bin/sstm-release src/main.cpp src/stb_image.cpp src/glad.c -lglfw -lGL -lX11 -lpthread -lXrandr -lXi -ldl -lassimp -lboost_serialization

test: CXXFLAGS += -O3
test:
	@g++ -fcoroutines -MD -Wall -Wextra -std=c++20 -O3 -Wfatal-errors -Wall -Wextra -Wshadow -Wconversion -Wnon-virtual-dtor -Wold-style-cast -Wcast-align -Wunused -Wmisleading-indentation -Wduplicated-cond -Wduplicated-branches -Wsign-conversion -Wlogical-op -Wnull-dereference -Wuseless-cast -Wdouble-promotion -Wformat=2 -Woverloaded-virtual -Wno-null-dereference -pedantic -Wswitch-enum -O3 -iquote include -isystem submodules -isystem external_header -o ./bin/sstm-test src/main.cpp src/stb_image.cpp src/glad.c -lglfw -lGL -lX11 -lpthread -lXrandr -lXi -ldl -lassimp -lboost_serialization
