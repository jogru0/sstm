...
private:
	...
	static void checkCompileErrors(GLuint shader, std::string_view type) {
		...
		//TODO:  The size of the buffer required to store the returned information log can be obtained by calling glGetShader with the value GL_INFO_LOG_LENGTH
